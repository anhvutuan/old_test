...
if ($_POST['action'] == "replace") {
	...
	$find_3 = $db->safesql( htmlspecialchars( strip_tags($_POST['find']), ENT_QUOTES, $config['charset'] ) );
	$replace_3 = $db->safesql( htmlspecialchars( strip_tags($_POST['replace']), ENT_QUOTES, $config['charset'] ) );
