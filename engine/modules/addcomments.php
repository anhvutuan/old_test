...
$parse->parse_links = $user_group[$member_id['user_group']]['allow_url'];
...
$name = isset($_POST['name']) ? $db->safesql( htmlspecialchars(strip_tags( trim( $_POST['name'] ) ), ENT_QUOTES, $config['charset'] ) ) : '';
