...
if ($allow_comments_ajax AND ( ($config['allow_quick_wysiwyg'] == "2" AND ($user_group[$member_id['user_group']]['allow_edit'] OR $user_group[$member_id['user_group']]['allow_all_edit']) ) OR $config['allow_comments_wysiwyg'] == "2" OR $config['comments_mobile_editor'] == "1") AND $dle_module != "addnews") {
