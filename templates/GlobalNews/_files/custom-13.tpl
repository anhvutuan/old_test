...
<div class="blog-post post-style-03">
	...
	<span class="badge badge-large [newscount=1]bg-pink[/newscount][newscount=2]bg-primary[/newscount][newscount=3]bg-yellow[/newscount][newscount=4]bg-blue[/newscount][newscount=5]bg-orange[/newscount][newscount=6]bg-red[/newscount]">
		{category}
	</span>
