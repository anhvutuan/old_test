...
<head>
  ...
  <title>Site disabled, technical work</title>
  <link rel="shortcut icon" href="https://cdn.csz.vn/templates/GlobalNews/images/favicon.svg" />
</head>
...
<div class="offline">
  <div class="offline__container">
      <h1 class="offline__title">Site disabled, technical work</h1>
